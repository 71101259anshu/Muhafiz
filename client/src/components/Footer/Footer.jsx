                ...
                <div className="footer-brand">
                    <Link to="/" className="brand-logo" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '10px' }}>
                        <div className="logo-icon-wrapper" style={{ width: '32px', height: '32px', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            <FaGraduationCap className="shield-icon" style={{ fontSize: '32px', color: '#1F3A5F' }} />
                            <FaCheckCircle className="check-icon" style={{ position: 'absolute', bottom: '-2px', right: '-4px', fontSize: '14px', color: '#2CB1BC', background: 'white', borderRadius: '50%', border: '2px solid white' }} />
                        </div>
                        <span className="brand-text" style={{ fontSize: '1.4rem', fontFamily: 'var(--font-main)' }}>
                            <span className="brand-primary" style={{ color: '#1F3A5F', fontWeight: '800' }}>Kviz</span>
